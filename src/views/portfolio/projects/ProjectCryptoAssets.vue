    ...
    <div id="cbomToolbar">
      <div class="form-inline btn-spaced-group" role="form">
        ...
        <b-button size="md" variant="outline-primary"
                  ...
                  v-permission="PERMISSIONS.PORTFOLIO_MANAGEMENT">
          <span class="fa fa-minus"></span> {{ $t('message.remove_cryptoAsset') }}
        </b-button>
        <b-button size="md" variant="outline-primary"
        ...
        <b-dropdown variant="outline-primary" v-permission="PERMISSIONS.PORTFOLIO_MANAGEMENT">
          <template #button-content>
            <span class="fa fa-download"></span> {{ $t('message.download_cbom') }}
          </template>
          <b-dropdown-item @click="downloadCbom('cbom')" href="#">{{ $t('message.inventory') }}</b-dropdown-item>
          <b-dropdown-item @click="downloadCbom('cbom_withVulnerabilities')" href="#">{{ $t('message.inventory_with_vulnerabilities') }}</b-dropdown-item>
        </b-dropdown>
      </div>
    </div>
    <bootstrap-table
