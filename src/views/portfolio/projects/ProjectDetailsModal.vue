  ...
  >
      ...
      <b-tab class="body-bg-color" style="border: 0; padding: 0" active>
        ...
        <b-card>
          ...
          <c-switch
            ...
            label
            :disabled="
              this.isNotPermitted([PERMISSIONS.PORTFOLIO_MANAGEMENT, PERMISSIONS.PORTFOLIO_MANAGEMENT_UPDATE]) ||
    ...
    <template v-slot:modal-footer="{ cancel }">
      ...
      <b-button
        ...
        v-permission:or="[PERMISSIONS.PORTFOLIO_MANAGEMENT, PERMISSIONS.PORTFOLIO_MANAGEMENT_CREATE]"
