<template>
  <b-modal id="projectAddComponentModal" size="md" hide-header-close no-stacking :title="$t('message.component_details')">
    ...
    <template v-slot:modal-footer="{ cancel }">
      ...
      <b-button size="md" variant="primary" @click="createComponent()" v-permission="PERMISSIONS.PORTFOLIO_MANAGEMENT">{{ $t('message.create') }}</b-button>
    </template>
  </b-modal>
</template>
