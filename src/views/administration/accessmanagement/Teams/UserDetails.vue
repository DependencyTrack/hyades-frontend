<template>
  <b-row class="expanded-row">
    <b-col sm="6">
      ...
      <b-form-group :label="this.$t('admin.api_keys')">
        <div class="list-group">
          <span v-for="apiKey in apiKeys" :key="apiKey.key">
      ...
      <b-form-group :label="this.$t('admin.mapped_ldap_groups')">
        <div class="list-group">
          <span v-for="ldapGroup in ldapGroups" :key="ldapGroup.dn">
            <actionable-list-group-item
              :value="ldapGroup.dn"
              :delete-icon="true"
      ...
      <b-form-group :label="this.$t('admin.mapped_oidc_groups')">
        <div class="list-group">
          <span
            v-for="mappedOidcGroup in mappedOidcGroups"
            :key="mappedOidcGroup.uuid"
          >
            <actionable-list-group-item
    ...
    <b-col sm="6">
      ...
      >
        <div class="list-group">
          <span v-for="managedUser in managedUsers" :key="managedUser.username">
            <actionable-list-group-item
      ...
      >
        <div class="list-group">
          <span v-for="ldapUser in ldapUsers" :key="ldapUser.username">
            <actionable-list-group-item
      ...
      >
        <div class="list-group">
          <span v-for="oidcUser in oidcUsers" :key="oidcUser.username">
            <actionable-list-group-item
...
export default {
  ...
  data() {
    return {
      ...
      // userManagementMixin variables
      identifierField: 'team',
    };
  },
  methods: {
    updateTeam: function () {
