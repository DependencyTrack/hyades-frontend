<template>
  <div class="animated fadeIn" v-permission:or="[PERMISSIONS.POLICY_MANAGEMENT, PERMISSIONS.POLICY_MANAGEMENT_CREATE, PERMISSIONS.POLICY_MANAGEMENT_READ, PERMISSIONS.POLICY_MANAGEMENT_UPDATE, PERMISSIONS.POLICY_MANAGEMENT_DELETE]">
    <b-tabs
      class="body-bg-color"
